...
if (-not $env:COI_ROOT) {
    ...
    Write-Host "Set it to your Captain of Industry install directory." -ForegroundColor Red
    exit 1
}
...
if (-not (Test-Path $basePath)) {
    Write-Host "ERROR: Game Managed folder not found at: $basePath" -ForegroundColor Red
    Write-Host "Check that COI_ROOT points to your game install directory." -ForegroundColor Red
    exit 1
}
